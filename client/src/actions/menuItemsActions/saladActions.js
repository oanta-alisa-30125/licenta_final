...
export const getAllSalads=()=>async dispatch=>{//dispatch=redux thunk function
...
export const filterSalads=(searchkey,category)=>async dispatch=>{//dispatch=redux thunk function

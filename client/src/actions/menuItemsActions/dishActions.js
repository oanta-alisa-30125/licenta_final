...
export const getAllDishes=()=>async dispatch=>{//dispatch=redux thunk function
...
export const filterDishes=(searchkey,category)=>async dispatch=>{//dispatch=redux thunk function
